...
/////////////////
const BotName = 'HAI REZA BOT☄'; 
const instagram = 'https://instagram.com/rezaahmadhasyim'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'KAPAN SAJA'; 
const youtube = 'https://www.youtube.com/c/belumbikin';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rezaahmadhasyim')
